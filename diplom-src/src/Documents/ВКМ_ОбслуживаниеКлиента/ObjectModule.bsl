...
//	КонецЕсли;
		...
		Запрос.Текст =
			...
			|	ВКМ_ОбслуживаниеКлиента.ВКМ_Договор.ВКМ_ДатаНачалаДействия КАК ДатаНачала,
			|	ВКМ_ОбслуживаниеКлиента.ВКМ_Договор.ВКМ_ДатаОкончанияДействия КАК ДатаОкончания
			...
			|	ВКМ_ОбслуживаниеКлиента.ВКМ_Договор.ВКМ_ДатаНачалаДействия,
			|	ВКМ_ОбслуживаниеКлиента.ВКМ_Договор.ВКМ_ДатаОкончанияДействия
			|;
			|
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			...
			|	вт_ДокОбслКл.ДатаНачала,
			|	вт_ДокОбслКл.ДатаОкончания
			|ИЗ
		...
		Пока Выборка.Следующий() Цикл
			...
			Если НЕ (Дата >= Выборка.ДатаНачала И Дата <= Выборка.ДатаОкончания) Тогда
					
			ТекстСообщения = "Проведение документа невозможно.
			|Проверьте дату документа: должна входить в период действия договора.";
			ОбщегоНазначения.СообщитьПользователю(ТекстСообщения,,,, Отказ);
